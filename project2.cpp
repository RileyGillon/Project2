...
struct ComparePriority {
    bool operator()(const PCB* a, const PCB* b) {
        ...
        // If same priority, earlier arrival or earlier last_run_time should come first
...
int main() {
    ...
    // Output the time quantum
    cout << "q = " << time_quantum << endl;
    ...
    while (cin >> line) {
        ...
        cout << p.id << " " << p.priority << " " << p.burst_time << " " << p.arrival_time << endl;
    }
